;(function($){
	...
	$("#travel").hover( function(event){
		$(".smallImg").hover(function() {
			$(this).attr("src",$(this).attr("src").replace("images/portfolio/web/travel_home.jpg","_over"));
		},function() {
			$(this).attr("src",$(this).attr("src").replace("_over","images/portfolio/web/travel_home.jpg"));
		});
		//$("#smallImg").attr("src", "img/d.png");
		console.info("hover");
	} );
